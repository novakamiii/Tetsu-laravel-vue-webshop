            ...
            <div class="-mx-4 flex flex-wrap">
                ...
                <div class="w-full px-4 md:w-1/2">
                    ...
                    <p class="mb-6 text-gray-700">
                        Experience premium sound quality and industry-leading
                        noise cancellation with these wireless headphones.
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex space-x-2">
                            <button
                                class="h-8 w-8 rounded-full bg-black focus:ring-2 focus:ring-black focus:ring-offset-2 focus:outline-none"
                            ></button>
                            <button
                                class="h-8 w-8 rounded-full bg-gray-300 focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 focus:outline-none"
                            ></button>
                            <button
                                class="h-8 w-8 rounded-full bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
                            ></button>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            min="1"
                            value="1"
                            class="focus:ring-opacity-50 w-12 rounded-md border-gray-300 text-center shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200"
                        />
                    </div>

                    <div class="mb-6 flex space-x-4">
                        <button
                            class="flex items-center gap-2 rounded-md bg-indigo-600 px-6 py-2 text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                        ...
                        <button
                            class="flex items-center gap-2 rounded-md bg-gray-200 px-6 py-2 text-gray-800 hover:bg-gray-300 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
